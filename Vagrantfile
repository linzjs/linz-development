...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.synced_folder "../linz-ghpages", "/ghpages/src"
  ...
  # configuration step 6: install ruby
  ...
  # configuration step 8: setup environment variables
