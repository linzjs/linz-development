...
htmlhelp_basename = 'linzjs'
file_insertion_enabled = False
latex_documents = [
  ('index', 'linzjs.tex', u'linzjs Documentation',
   u'', 'manual'),
]
...
context = {
    ...
    'downloads': [
    ("pdf", "//readthedocs.org/projects/linzjs/downloads/pdf/latest/"),
    ("htmlzip", "//readthedocs.org/projects/linzjs/downloads/htmlzip/latest/"),
    ("epub", "//readthedocs.org/projects/linzjs/downloads/epub/latest/"),
    ],
    'subprojects': [
    ],
    'slug': 'linzjs',
    'name': u'linzjs',
    'rtd_language': u'en',
    'canonical_url': 'http://linzjs.readthedocs.io/en/latest/',
    'analytics_code': 'None',
